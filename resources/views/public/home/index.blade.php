...
<div class="slider-area">
			...
			<div class="block-slider block-slider4">
				<ul class="" id="bxslider-home4">
					...
					<li><img src="{{asset('/')}}public/img/h4-slide2.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="{{asset('/')}}public/img/h4-slide3.png" alt="Slide">
						<div class="caption-group">
							<h2 class="caption title">
					...
					<li><img src="{{asset('/')}}public/img/h4-slide4.png" alt="Slide">
						<div class="caption-group">
						  <h2 class="caption title">
								Apple <span class="primary">Store <strong>Ipod</strong></span>
							</h2>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <a href="#" class="wid-view-more">View All</a>
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="{{asset('/')}}public/img/product-thumb-4.jpg" alt="" class="product-thumb"></a>
