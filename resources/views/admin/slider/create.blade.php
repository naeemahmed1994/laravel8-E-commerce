        ...
        <div class="card-body">
            ...
            @csrf
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="first_heading_text" placeholder="Enter Slider Heading 1">
                  </div>
                  <div class="form-group">
                    <label>Slider Heading 2</label>
                    <input type="text" class="form-control" name="second_heading_text" placeholder="Enter Slider Heading 2">
                  </div>
                  <div class="form-group">
